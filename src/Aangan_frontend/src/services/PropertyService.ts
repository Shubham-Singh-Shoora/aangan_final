...
export class PropertyService {
    ...
    async getLandlordProperties() {
        try {
            const properties = await this.actor.get_my_properties();
            return properties.map(formatPropertyForDisplay);
        } catch (error) {
...
export const formatPropertyForDisplay = (property: any) => {
